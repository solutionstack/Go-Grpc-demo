...
func StartNew(handler handler.Handler) error {
	http.HandleFunc("/api/user/create", handler.CreateNewUser)
	http.HandleFunc("/api/users", handler.GetAll)
	http.HandleFunc("/api/user", handler.GetSingle)
